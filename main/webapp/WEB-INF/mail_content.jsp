                                ...
                                <tr>
                                    <td class="esd-stripe" align="center">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="700">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p40t es-p20r es-p20l" align="left" esd-custom-block-id="334500">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="660" class="esd-container-frame" align="center" valign="top">
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20b es-p20r es-p20l" align="left" esd-custom-block-id="334501">
                                                        <!--[if mso]><table width="660" cellpadding="0" cellspacing="0"><tr><td width="310" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="310" class="es-m-p20b esd-container-frame" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p5b es-m-txt-l">
                                                                                        <h3>Ask at</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-button es-p10t es-p10b es-m-txt-l"><span class="es-button-border" style="background: #ffffff; display: block;"><a href="mailto:" class="es-button" target="_blank" style="background: #ffffff; border-color: #ffffff; border-left-width: 30px; border-right-width: 30px; display: block;">cosmin.gligan@gmail.com</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="310" align="left" class="esd-container-frame">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-m-txt-l es-p10t es-p5b">
                                                                                        <h3>Visit our</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-button es-m-txt-l es-p10t es-p10b"><span class="es-button-border" style="background: #ffffff; display: block;"><a href="http://localhost:8080/help/" class="es-button es-button-1620385738243" target="_blank" style="background: #ffffff; border-color: #ffffff; border-width: 10px 30px; display: block;">Help center</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" valign="top" class="es-p30r">
                                                                                                        <img title="Facebook" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/facebook-square-black-bordered.png" alt="Fb" width="32">
                                                                                                    </td>
                                                                                                    <td align="center" valign="top" class="es-p30r">
                                                                                                        <img title="Twitter" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/twitter-square-black-bordered.png" alt="Tw" width="32">
                                                                                                    </td>
                                                                                                    <td align="center" valign="top" class="es-p30r">
                                                                                                        <img title="Instagram" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/instagram-square-black-bordered.png" alt="Inst" width="32">
                                                                                                    </td>
                                                                                                    <td align="center" valign="top">
                                                                                                        <img title="Youtube" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/youtube-square-black-bordered.png" alt="Yt" width="32">
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
